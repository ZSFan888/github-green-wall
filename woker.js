  ...
  <ul class="step-list">
    <li class="step">
      ...
      <div class="step-body">
        ...
        <a href="https://github.com/ZSFan888/AutoWall/fork" target="_blank" class="big-btn">
          <span class="fork-icon"><span class="fork-line"></span></span>
          Fork ZSFan888/AutoWall
        </a>
      </div>
    </li>
    <li class="step">
    ...
    <li class="step">
      ...
      <div class="step-body">
        ...
        <div class="step-desc">
          ...
          <code>仓库名</code> — Fork 后的仓库名，默认为 <code>AutoWall</code><br/>
...
<div id="adminPanel" style="display:none">
  <div class="card">
    ...
    <div class="row2">
      <div class="field"><label>GitHub 用户名</label><input id="cfOwner" class="input" placeholder="ZSFan888"/></div>
      <div class="field"><label>仓库名</label><input id="cfRepo" class="input" placeholder="AutoWall"/></div>
    </div>
    <div class="gap8"></div>
    <div class="row2">
